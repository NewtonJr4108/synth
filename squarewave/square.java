    ...
    public static void main(String[] args){
        ...
        while (true){
          ...
          //plays major seventh chord based on input frequency
            ...
            square.createTone(h, 100);
            square.createTone(third, 100);
            square.createTone(fifth, 100);
            square.createTone(seventh, 100);
            square.createTone(octave, 100);
        ...
        for(int i=0; i<rate; i++){
            double angle = (i/rate)*Hertz*Math.PI;
            buf[0]=(byte)(Math.signum(Math.sin(angle)*volume));
